...
public class FeralCatEntity extends TamableAnimal {
	public final AnimationState animationState0 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();

	public FeralCatEntity(EntityType<FeralCatEntity> type, Level world) {
		super(type, world);
		xpReward = 8;
		setNoAi(false);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		FeralCatEntity retval = MurmolModEntities.FERAL_CAT.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return CompoundIngredient.of(Ingredient.of(new ItemStack(Items.COD)), Ingredient.of(new ItemStack(Items.SALMON)), Ingredient.of(new ItemStack(Items.TROPICAL_FISH)), Ingredient.of(new ItemStack(Items.PUFFERFISH)),
				Ingredient.of(ItemTags.create(ResourceLocation.parse("minecraft:fish")))).test(stack);
	}

	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MurmolModEntities.FERAL_CAT.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
