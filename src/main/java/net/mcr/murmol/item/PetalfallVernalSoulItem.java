...
public class PetalfallVernalSoulItem extends Item {
	public PetalfallVernalSoulItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		FeralFormManager.transformFromItem(world, x, y, z, entity, FeralForms.LUOHONG, itemstack);
		return retval;
	}
}